...
const SingleMovie = () => {
  ...
  return (
    <Card
      ...
      //   title={movie.title}
      title={
        <Button className="btn-primary float_right" onClick={() => navigate("/")} type="link">
          Back to Home
        </Button>
      }
    >
      <Row className="border p-3 rounded shadow">
        <Col span={4}>
        ...
        <Col span={20} className="px-3">
          ...
          <Row>
            <Col className="font-700" span={4}>Imdb Rating :</Col>
            <Col span={20}  className="pl-2 mb-2">{movie.imdbRating}</Col>
          </Row>
          <Row>
            <Col className="font-700" span={4}>Content Rating :</Col>
            <Col span={20}  className="pl-2 mb-2">{movie.contentRating}</Col>
          </Row>
          <Row>
            <Col className="font-700" span={4}>Average Rating :</Col>
            <Col span={20}  className="pl-2 mb-2">{movie.averageRating}</Col>
          </Row>
          <Row>
            <Col className="font-700" span={4}>Duration :</Col>
            <Col span={20}  className="pl-2 mb-2">{movie.duration}</Col>
          </Row>
          <Row>
            <Col className="font-700" span={4}>Genres :</Col>
          ...
          <Row>
            <Col className="font-700" span={4}>Actors :</Col>
            <Col span={20}  className="pl-2 mb-2">
              {movie &&
                movie.actors &&
          ...
          <Row>
            <Col className="font-700" span={4}>Release Date :</Col>
            <Col span={20}  className="pl-2 mb-2">{movie.releaseDate}</Col>
          </Row>
          <Row>
            <Col className="font-700" span={4}>Story line :</Col>
